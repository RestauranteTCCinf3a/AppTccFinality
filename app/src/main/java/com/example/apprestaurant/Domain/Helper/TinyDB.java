...
public class TinyDB {
    ...
    public ArrayList<CardapioModel> getListObject(String key){
        Gson gson = new Gson();

        ArrayList<String> objStrings = getListString(key);
        ArrayList<CardapioModel> playerList =  new ArrayList<CardapioModel>();

        for(String jObjString : objStrings){
            CardapioModel player  = gson.fromJson(jObjString,  CardapioModel.class);
    ...
    public void putListObject(String key, ArrayList<CardapioModel> playerList){
        checkForNullKey(key);
        Gson gson = new Gson();
        ArrayList<String> objStrings = new ArrayList<String>();
        for(CardapioModel player: playerList){
